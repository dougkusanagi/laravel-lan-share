...
return [
    ...
    'pairing' => [
        ...
        'max_connect_attempts' => max(10, (int) env('LAN_SHARE_PAIRING_MAX_CONNECT_ATTEMPTS', 30)),
        'connect_rate_limit_seconds' => max(30, (int) env('LAN_SHARE_PAIRING_CONNECT_RATE_LIMIT_SECONDS', 60)),
    ],
